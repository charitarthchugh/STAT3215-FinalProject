...
```{r}
models <- list() 
results = data.frame(name=character(),alpha=numeric(),mse=numeric(),mae=numeric(),vecv=numeric())
...
for (i in 0:20) {
 ...
 results = rbind(results, data.frame(name=name,alpha=i/20,mse=mse,mae=mae,vecv=vecv))
} 
results
