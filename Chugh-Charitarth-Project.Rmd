...
Based on the test for non-constant variance, we are able to reject the null hypothesis - We cannot assume constant variance in this model. - Transform regressors
