...
coef(lasso_metrics, s = lasso.predicted$lambda.1se)
idx_1se <- which(abs(coef(out.lasso, s = out.lasso$lambda.1se)) > 0)
rownames(coef(out.lasso, s = out.lasso$lambda.1se))[idx_1se]
lasso_metrics
```
