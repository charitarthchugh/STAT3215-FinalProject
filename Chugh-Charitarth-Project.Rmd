...
Dep Delay = 19.40 + (1.007) CarrierDelay + (1.012) Late Aircraft Delay + (0.9252) NAS Delay + (0.991) Weather Delay - (0.757) Taxi Out - (0.7858) TaxiIn + (0.99924) SecurityDelay + (3.634)(10\^{-3}) Distance
...
x.test<- as.matrix(df_test[,1:9]) 
y.test<- df_test$DepDelay
x.train <- as.matrix(df_train[,1:9])
y.train <- df_train$logDepDelay
n.test <- dim(df_test)[1]
syy.test <- (n.test-1)*var(y.test)
